    ...
    return (
      <EmployeeLayout>
        <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
          ...
          <p className="text-muted-foreground text-sm">Loading company policy...</p>
        </div>
      </EmployeeLayout>
    );
  }
    ...
    return (
      <EmployeeLayout>
        <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
          ...
          <h2 className="font-heading text-xl font-bold text-foreground">No Company Policy Available</h2>
      ...
      <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="font-heading text-3xl font-extrabold tracking-tight text-foreground mb-1">
              {policy.policyName}
            </h1>
            <div className="flex flex-wrap items-center gap-3 text-sm text-muted-foreground">
              ...
              <span>•</span>
              <span className="px-2 py-0.5 bg-emerald-500/10 text-emerald-600 border border-emerald-500/20 rounded text-xs font-bold">
                ACTIVE
              </span>
            </div>
          </div>
