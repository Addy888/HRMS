...
const STATUSES = [
  { value: 'DRAFT', label: 'Draft', color: 'bg-background0/10 text-muted-foreground border-neutral-500/20' },
  { value: 'ISSUED', label: 'Issued', color: 'bg-blue-500/10 text-blue-600 border-blue-500/20' },
  { value: 'SENT', label: 'Sent', color: 'bg-purple-500/10 text-purple-600 border-purple-500/20' },
  ...
  { value: 'RESPONSE_PENDING', label: 'Response Pending', color: 'bg-amber-500/10 text-amber-600 border-amber-500/20' },
  { value: 'RESPONSE_SUBMITTED', label: 'Response Submitted', color: 'bg-emerald-500/10 text-emerald-600 border-emerald-500/20' },
...
const SEVERITIES = [
  { value: 'LOW', label: 'Low', color: 'text-blue-600', bg: 'bg-blue-500/10' },
  ...
  { value: 'CRITICAL', label: 'Critical', color: 'text-red-600', bg: 'bg-red-500/10' },
];
...
const StatusBadge = ({ status }: { status: string }) => {
  ...
  return (
    <span className={`text-xs font-bold uppercase px-3 py-1.5 rounded-full border ${config?.color || 'bg-background0/10 text-muted-foreground border-neutral-500/20'}`}>
      {config?.label || status}
    </span>
  );
};
...
const SeverityBadge = ({ severity }: { severity: string }) => {
  ...
  return (
    <span className={`inline-flex items-center gap-1.5 text-xs font-bold uppercase px-3 py-1.5 rounded-full ${config?.bg} ${config?.color || 'text-muted-foreground'}`}>
...
export default function HRActionHistoryPage() {
  ...
  return (
    <HRLayout>
        ...
        <div className="bg-secondary border border-border rounded-xl p-6">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <select
              ...
              className="px-4 py-2.5 bg-background border border-border rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
        ...
        <div className="bg-secondary border border-border rounded-xl overflow-hidden">
          {isLoading ? (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <div className="text-xs text-muted-foreground">{action.employee?.employeeId}</div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <button
                          ...
                          className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-foreground rounded-lg transition-colors flex items-center gap-2 text-sm font-semibold"
                        >
            ...
            <div className="px-6 py-20 text-center">
              <History className="w-16 h-16 text-card-foreground mx-auto mb-4" />
              <h3 className="text-lg font-bold text-foreground mb-2">No HR Action History</h3>
            ...
            <div className="flex items-center justify-between border-t border-border px-6 py-4 bg-card">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  disabled={page === 1}
                  className="p-2 rounded-lg bg-muted hover:bg-secondary disabled:opacity-30 text-muted-foreground hover:text-foreground transition-colors"
                >
                  <ChevronLeft className="w-4 h-4" />
                </button>
                <span className="text-sm text-foreground px-3">Page {page} of {meta.totalPages}</span>
                <button
      ...
      {/* Action Detail Modal */}
      {selectedAction && (
        <div className="fixed inset-0 bg-background/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
          <div className="bg-secondary border border-border rounded-xl p-6 max-w-5xl w-full my-8 max-h-[90vh] overflow-y-auto">
            <div className="space-y-6">
              {/* Header */}
              <div className="flex items-start justify-between border-b border-border pb-6">
                <div>
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h2 className="text-2xl font-bold text-foreground">HR Action Complete History</h2>
                  </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-background/40 rounded-lg p-5 border border-border">
                  <div>
                    <div className="text-xs text-muted-foreground mb-1 font-semibold uppercase">Employee</div>
                    <div className="flex items-center gap-2">
                      <User className="w-4 h-4 text-muted-foreground" />
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground">{selectedAction.employee?.employeeId}</div>
                      </div>
                    </div>
                  </div>
                  ...
                  {selectedAction.employee?.department && (
                    <div>
                      <div className="text-xs text-muted-foreground mb-1 font-semibold uppercase">Department</div>
                  ...
                  <div>
                    <div className="text-xs text-muted-foreground mb-1 font-semibold uppercase">Action Type</div>
                    <div className="text-foreground font-semibold">
                  ...
                  <div>
                    <div className="text-xs text-muted-foreground mb-1 font-semibold uppercase">Incident Date</div>
                  ...
                  <div>
                    <div className="text-xs text-muted-foreground mb-1 font-semibold uppercase">Created By</div>
                    <div className="text-foreground">
                  ...
                  <div>
                    <div className="text-xs text-muted-foreground mb-1 font-semibold uppercase">Created At</div>
                    <div className="text-foreground">
                  ...
                  {selectedAction.issuedAt && (
                    <div>
                      <div className="text-xs text-muted-foreground mb-1 font-semibold uppercase">Issued At</div>
                  ...
                  {selectedAction.viewedAt && (
                    <div>
                      <div className="text-xs text-muted-foreground mb-1 font-semibold uppercase">Viewed At</div>
                ...
                <div className="mt-4 space-y-4">
                  <div>
                    <div className="text-xs text-muted-foreground mb-2 font-semibold uppercase">Subject</div>
                    <div className="text-foreground font-semibold text-lg">{selectedAction.subject}</div>
                  </div>

                  <div>
                    <div className="text-xs text-muted-foreground mb-2 font-semibold uppercase">Reason / Description</div>
                    <div className="text-card-foreground whitespace-pre-wrap bg-muted/30 rounded-lg p-4 border border-border leading-relaxed">
                  ...
                  {selectedAction.correctiveAction && (
                    <div>
                      <div className="text-xs text-muted-foreground mb-2 font-semibold uppercase">Required Corrective Action</div>
                      <div className="text-card-foreground whitespace-pre-wrap bg-muted/30 rounded-lg p-4 border border-border leading-relaxed">
                        {selectedAction.correctiveAction}
                      </div>
                    </div>
                  ...
                  {selectedAction.additionalRemarks && (
                    <div>
                      <div className="text-xs text-muted-foreground mb-2 font-semibold uppercase">Additional Remarks</div>
                      <div className="text-card-foreground whitespace-pre-wrap bg-muted/30 rounded-lg p-4 border border-border leading-relaxed">
                        {selectedAction.additionalRemarks}
                      </div>
                    </div>
                ...
                <div>
                  ...
                  {selectedAction.responseText ? (
                    <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-lg p-5 space-y-3">
                      ...
                      <div className="text-card-foreground whitespace-pre-wrap bg-background/40 rounded-lg p-4 border border-emerald-500/20 leading-relaxed">
                        {selectedAction.responseText}
                      </div>
                    </div>
                  ) : (
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {actionDetails.auditLogs.map((log: any, index: number) => (
                      <div
                        key={log.id}
                        className="flex gap-4 bg-muted/30 rounded-lg p-4 border border-border"
                      >
              ...
              {selectedAction.resolvedAt && (
                <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-5">
                  ...
                  {selectedAction.resolvedRemarks && (
                    <div className="text-card-foreground bg-background/40 rounded-lg p-4 border border-green-500/20">
                      {selectedAction.resolvedRemarks}
                    </div>
                  )}
                </div>
              ...
              <div className="flex justify-end border-t border-border pt-6">
                <button
                  onClick={() => setSelectedAction(null)}
                  className="px-6 py-2.5 bg-secondary hover:bg-secondary/50 text-foreground rounded-lg transition-colors font-semibold"
                >
                  Close
                </button>
              </div>
