    ...
    return (
      <HRLayout>
        <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-4">
          ...
          <button
            onClick={() => refetch()}
            className="px-4 py-2 bg-blue-500 hover:bg-blue-600 text-foreground rounded-xl text-sm font-semibold transition-colors"
          >
            Retry
          </button>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-secondary hover:bg-secondary/50 text-foreground rounded-xl text-sm font-semibold transition-colors disabled:opacity-50"
            >
              <RefreshCw
            ...
            {selectedSlips.length > 0 && (
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 bg-blue-500 hover:bg-blue-600 text-foreground rounded-xl text-sm font-semibold transition-colors disabled:opacity-50"
              >
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full px-4 py-2.5 bg-secondary border border-border rounded-xl text-foreground focus:outline-none focus:ring-2 focus:ring-blue-500/50 text-sm appearance-none cursor-pointer"
                >
        ...
        <div className="bg-card border border-border rounded-2xl overflow-hidden">
          ...
          {slipsLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 px-6">
              ...
              <h3 className="font-semibold text-foreground mb-2">No salary slips found</h3>
                  ...
                  <tr>
                    <th className="px-6 py-3 text-left">
                      <input
                        ...
                        className="w-4 h-4 rounded border-border bg-secondary text-blue-500 focus:ring-2 focus:ring-blue-500/50"
                      />
                    </th>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center justify-end gap-2">
                            <button
                              ...
                              className="p-2 hover:bg-secondary rounded-lg text-blue-600 hover:text-blue-300 transition-colors disabled:opacity-50"
                              title="Download PDF"
                            >
                            ...
                            <button
                              ...
                              className="p-2 hover:bg-secondary rounded-lg text-purple-600 hover:text-purple-300 transition-colors disabled:opacity-50"
                            ...
                            <button
                              ...
                              className="p-2 hover:bg-secondary rounded-lg text-emerald-600 hover:text-emerald-300 transition-colors disabled:opacity-50"
                            ...
                            <button
                              ...
                              className="p-2 hover:bg-secondary rounded-lg text-red-600 hover:text-red-300 transition-colors disabled:opacity-50"
                              title="Delete"
                            >
