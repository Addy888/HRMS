    ...
    return (
      <HRLayout>
        <div className="flex flex-col items-center justify-center min-h-[60vh]">
          ...
          <button
            onClick={() => refetch()}
            className="mt-6 px-6 py-2 bg-blue-600 hover:bg-blue-700 text-foreground rounded-lg transition-colors"
          >
            Retry
          </button>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm text-muted-foreground">
              Total: <span className="text-foreground font-semibold">{totalEmployees}</span>{' '}
              employees
            </span>
          </div>
        </div>
        ...
        <div className="bg-card border border-border rounded-2xl overflow-hidden">
          {employees.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 px-6">
              <DollarSign className="w-16 h-16 text-card-foreground mb-4" />
                          ...
                          <div className="flex items-center justify-center gap-2">
                            {employee.salaryStructureId ? (
                              ...
                              <button
                                ...
                                className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-foreground text-xs rounded-lg transition-colors"
                              >
                                Configure
                              </button>
                            )}
