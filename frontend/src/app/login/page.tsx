    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-3xl animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-8">
        <div className="text-center space-y-2">
          <h1 className="font-heading text-4xl font-extrabold text-foreground tracking-tight">FCS Portal</h1>
          <p className="text-sm text-muted-foreground">Select your access portal to continue signing in</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <button
            ...
            className="flex flex-col justify-between text-left p-8 bg-card hover:bg-accent/50 border border-border hover:border-blue-500/50 rounded-3xl shadow-xl transition-all group relative overflow-hidden"
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                <h2 className="font-heading text-xl font-bold text-foreground">HR Administrator</h2>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Manage the corporate directory, onboard new employees, review documents, and configure designations.
                </p>
              </div>
            </div>
            <div className="flex items-center gap-1.5 text-xs font-bold text-blue-600 mt-8 group-hover:text-blue-300">
          ...
          <button
            ...
            className="flex flex-col justify-between text-left p-8 bg-card hover:bg-accent/50 border border-border hover:border-emerald-500/50 rounded-3xl shadow-xl transition-all group relative overflow-hidden"
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                <h2 className="font-heading text-xl font-bold text-foreground">Employee Self-Service</h2>
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Complete onboarding checklist, upload government forms, read company policies, and view details.
                </p>
              </div>
            </div>
            <div className="flex items-center gap-1.5 text-xs font-bold text-emerald-600 mt-8 group-hover:text-emerald-300">
