        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-neutral-400 uppercase">Corporate Email</label>
              <input
                type="email"
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                <Link href="/forgot-password" className="text-xs text-emerald-400 hover:text-emerald-300 font-medium">Forgot Password?</Link>
              </div>
            ...
            <div className="flex items-center gap-2 py-1">
              ...
              />
              <label htmlFor="remember-emp" className="text-xs text-neutral-400 font-medium select-none cursor-pointer">Remember me for 30 days</label>
            </div>
