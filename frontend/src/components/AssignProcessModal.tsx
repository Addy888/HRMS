      ...
      <div className="bg-card border border-border rounded-2xl max-w-md w-full shadow-2xl">
        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground">Change Process</h3>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="bg-secondary rounded-xl p-4 border border-border">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-600 to-indigo-700 flex items-center justify-center font-heading text-sm font-bold text-foreground uppercase shrink-0">
