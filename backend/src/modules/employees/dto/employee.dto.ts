...
export class CreateEmployeeDto {
  ...
  @ApiProperty({
    ...
    example: '123 Tech Park Suite, Delhi',
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Emergency contact detail name/number',
    example: 'Amit Sharma: 9988776655',
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'UUID of the mapped department',
    example: 'd5005bed-a9ea-462b-8bed-9f3bf97fb660',
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'UUID of the mapped designation',
    example: '4daecbb5-3e4b-4a85-8349-3ad553703d5b',
    required: false,
  })
  @IsString()
  @IsOptional()
...
export class QueryEmployeeDto {
  @ApiProperty({
    description: 'Search term for name/email/ID',
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Filter by onboardingStatus',
    example: 'PENDING',
    required: false,
  })
  @IsString()
