...
export class NotificationsController {
  ...
  @ApiOperation({
    summary:
      'Get paginated notifications for the current user (search, filter)',
  })
  ...
  @Patch(':id/read')
  @ApiOperation({
    summary: 'Mark a single notification as read by recipient record ID',
  })
  ...
  @Delete(':id')
  @ApiOperation({
    summary: 'Delete a notification (for the current user only)',
  })
  deleteNotification(
    @GetUser('id') userId: string,
  ...
  @ApiOperation({
    summary:
      'Broadcast a notification (HR only) to All, Department, Designation, or specific Employee',
  })
  broadcastNotification(
    @GetUser('id') hrId: string,
  ...
  @ApiOperation({
    summary:
      'Update notification preferences (email, inApp, push, sound, doNotDisturb)',
  })
  updatePreferences(
    @GetUser('id') userId: string,
  ...
  @ApiOperation({
    summary: 'Mark announcement as read (by AnnouncementRecipient ID)',
  })
